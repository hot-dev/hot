---
name: group-summary
description: How Team Brain should structure /summary and /decisions output for a Telegram group.
when:
  - summarize the group
  - generate digest
  - extract decisions
...
# Summarizing a Telegram group

Team Brain summaries are read on a phone, between meetings. Optimize
...
- Quote teammates by their Telegram display name in `<b>…</b>`. Avoid
