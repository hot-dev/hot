...
mod tests {
    ...
    fn resolve_source_path_supports_absolute_legacy_suffix() {
        let candidates = vec!["hot/src/team-brain/agent.hot".to_string()];
        assert_eq!(
            resolve_source_path_from_candidates(
                "/Users/example/project/hot/src/team-brain/agent.hot",
                &candidates
            ),
            Some("hot/src/team-brain/agent.hot".to_string())
        );
    }
